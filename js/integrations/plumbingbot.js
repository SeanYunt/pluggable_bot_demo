...
(function(){
  ...
  function init({container}){
    ...
    async function handleSend(){
      ...
      if(!text) return;
      if(window.BotIntent) window.BotIntent.track('BluePipe Plumbing', text, firedIntents, pendingConversions);
      ...
      try {
        ...
        if(window.BotIntent) window.BotIntent.trackReply(data.reply, pendingConversions, 'BluePipe Plumbing');
